...
//		List<String> sentencesList = getTokens("[^.!?]+");
//		List<String> wordsList = getTokens("[a-zA-Z]+");
////		System.out.println("print begin");
////		for (String s : sentencesList) {
////			System.out.println(s);
////		}
//		if (sentencesList.size() == 0 && wordsList.size() == 1) return 1;
	...
	{
		// My previous naive answer:
//		// String regexp = "[bcdfghjklmnpqrstvwxz]*[aeiouy]+[bcdfghjklmnpqrstvwxz]*(e[\\s.!?])?";
//		String regexp = "([AIOUYaiouy]+e*)|([AIOUYEaiouye]+[bcdfghjklmnpqrstvwxz]+)|(\\s[BCDFGHJKLMNPQRSTVWXZbcdfghjklmnpqrstvwxz]+e\\s)";
//		List<String> syllablesList = getTokens(regexp);
////		System.out.println("print begin");
////		for (String s : syllablesList) {
////			System.out.println(s);
////		}
//        return syllablesList.size();
