...
public class GraphAdjList extends Graph {
	 ...
	 */		
	 public List<Integer> getDistance2(int v) {
		 ...
		 List<Integer> next2 = new ArrayList<Integer>();
		 List<Integer> tempNext = new ArrayList<Integer>();
		 for (int n : next) {
			 tempNext = getNeighbors(n);
			 next2.removeAll(tempNext);
			 next2.addAll(tempNext);
		 }
		 return next2;
	}
